      ...
      <div>
        ...
        <form>
          ...
          <div className="RX-eye-row-select">
            <select id="ODSPH" defaultValue="PL/0" onChange={this.onRXChange} required>
            ...
            <select id="ODAXIS" defaultValue="Blank/0" onChange={this.onRXChange} required>
            ...
            <select id="ODadd" defaultValue="" onChange={this.onRXChange} required>
          ...
          <div className="RX-eye-row-select">
            <select id="OSSPH" defaultValue="PL/0" onChange={this.onRXChange} required>
              <option value="-20.00">-20.00</option>
              <option value="-19.75">-19.75</option>
              <option value="-19.50">-19.50</option>
              <option value="-19.25">-19.25</option>
            ...
            <select id="OSAXIS" defaultValue="Blank/0" onChange={this.onRXChange} required>
              <option value="Blank/0">Blank/0</option>
              <option value="001">001</option>
              <option value="002">002</option>
              <option value="003">003</option>
            ...
            <select id="OSadd" defaultValue="" onChange={this.onRXChange} required>
              <option value="0">0</option>
              <option value="+0.25">+0.25</option>
              <option value="+0.50">+0.50</option>
              <option value="+0.75">+0.75</option>
          ...
          {hasTwoPD ? (
            <div>
              <span className="RX-eye-PD">
                <select id="ODPD" defaultValue="Right(OD)" onChange={this.onRXChange} required>
              ...
              <span className="RX-eye-PD">
                <select id="OSPD" defaultValue="Left(OS)" onChange={this.onRXChange} required>
                  <option value="24">24</option>
                  <option value="24.5">24.5</option>
                  <option value="25">25</option>
                  <option value="25.5">25.5</option>
          ...
          <input type="checkbox" id="hasTwoPD" onChange={this.handleCheck} defaultChecked={this.state.hasTwoPD} />
          <label className="RX-checkbox-label">My PD has 2 numbers</label>
          <input type="checkbox" id="hasPrism" onChange={this.handleCheck} defaultChecked={this.state.hasPrism} />
          <label className="RX-checkbox-label">My prescription has prism</label>
          {hasPrism && (
            <div>
              <label className="RX-eye-label">Right Eye (OD)</label>
              <div className="RX-eye-row-select">
                <select id="OD-prism-horiz" defaultValue="" onChange={this.onRXChange} required>
                  <option value="0">0</option>
                ...
                <select id="OD-prism-horiz-dir" defaultValue="" onChange={this.onRXChange} required>
                  <option value="In">In</option>
                  <option value="Out">Out</option>
                </select>
                <select id="OD-prism-vert" defaultValue="" onChange={this.onRXChange} required>
                  <option value="0">0</option>
                  <option value="0.10">0.10</option>
                  <option value="0.20">0.20</option>
                  <option value="0.30">0.30</option>
                ...
                <select id="OD-prism-vert-dir" defaultValue="" onChange={this.onRXChange} required>
              ...
              <div className="RX-eye-row-select">
                <select id="OS-prism-horiz" defaultValue="" onChange={this.onRXChange} required>
                  <option value="0">0</option>
                  <option value="0.10">0.10</option>
                  <option value="0.20">0.20</option>
                  <option value="0.30">0.30</option>
                ...
                <select id="OS-prism-horiz-dir" defaultValue="" onChange={this.onRXChange} required>
                  <option value="In">In</option>
                  <option value="Out">Out</option>
                </select>
                <select id="OS-prism-vert" defaultValue="" onChange={this.onRXChange} required>
                  <option value="0">0</option>
                  <option value="0.10">0.10</option>
                  <option value="0.20">0.20</option>
                  <option value="0.30">0.30</option>
                ...
                <select id="OS-prism-vert-dir" defaultValue="" onChange={this.onRXChange} required>
                  <option value="Up">Up</option>
                  <option value="Down">Down</option>
                </select>
              </div>
...
const mapDispatchToProps = dispatch => ({
  postRX: () => dispatch(postRX()),
  getRXs: () => dispatch(getRXs()),
